...
function registerServiceWorker() {
    if ('serviceWorker' in navigator) {
        ...
        window.addEventListener('beforeinstallprompt', (e) => __awaiter(this, void 0, void 0, function* () {
            try {
                ga('send', 'event', 'PWA', 'See', 'Add to homescreen');
                const choiceResult = yield e.userChoice;
...
// Imports
var ___CSS_LOADER_API_IMPORT___ = __webpack_require__(338);
