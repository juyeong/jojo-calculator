...
(function(root, factory) {
  ...
  var SUPPORTS_VALIDITY_API =
    !/android/i.test(window.navigator.userAgent) && !!document.createElement("input").validity;
  ...
  $.extend(Selectize.prototype, {
    ...
    advanceSelection: function(direction, e) {
      ...
      if (self.isFocused && !self.isInputHidden) {
        ...
        cursorAtEdge =
          direction < 0 ? selection.start === 0 && selection.length === 0 : selection.start === valueLength;
